...
# Data loading params
tf.flags.DEFINE_string("pos_dir", "../cnn-text-classification-tf/data/MR_polarity_5k/rt-polarity-test.pos", "Path of positive data")
tf.flags.DEFINE_string("neg_dir", "../cnn-text-classification-tf/data/MR_polarity_5k/rt-polarity-test.neg", "Path of negative data")
...
def eval():
    ...
    elif FLAGS.dataset == 'COVID_Chinese':
        x_text, y = data_helpers.load_COVID_Chinese('../data/COVID_Chinese', train=False)
    elif FLAGS.dataset == 'SST-5':
        x_text, y = data_helpers.load_SST5('../data/SST-5', train=False)
