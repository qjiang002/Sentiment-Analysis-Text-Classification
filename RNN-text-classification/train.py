...
# Data loading params
tf.flags.DEFINE_string("pos_dir", "../cnn-text-classification-tf/data/MR_polarity_5k/rt-polarity.pos", "Path of positive data")
tf.flags.DEFINE_string("neg_dir", "../cnn-text-classification-tf/data/MR_polarity_5k/rt-polarity.neg", "Path of negative data")
...
def preprocessing():
    ...
    if FLAGS.dataset == 'COVID_Chinese':
        ...
        vocab_processor = tf.contrib.learn.preprocessing.VocabularyProcessor(FLAGS.max_sentence_length, tokenizer_fn=chinese_tokenizer)
        ...
        return train_text, dev_text, vocab_processor, train_label, dev_label
    ...
    # Load data
    if FLAGS.dataset == 'MR':
        x_text, y = data_helpers.load_MR(FLAGS.pos_dir, FLAGS.neg_dir)
        ...
        return x_train, x_dev, text_vocab_processor, y_train, y_dev

def train(x_train, x_dev, text_vocab_processor, y_train, y_dev):
...
def main(_):
    x_train, x_dev, text_vocab_processor, y_train, y_dev = preprocessing()
    train(x_train, x_dev, text_vocab_processor, y_train, y_dev)
